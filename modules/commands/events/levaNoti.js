...
(typeof data.customLeave == "undefined") ? msg = "[⚜️] {name} رحل عنا . {type}  [⚜️]\n●▬▬▬▬๑۩۩๑▬▬▬▬●\n🌺🌸🌺 شكرا لك عزيزي {name} على الوقت اللذي قضيته معنا. نتمنى ان نراك في المستقبل <3😊💔\n\n[❤️‍🔥] ووداعا. كن سعيدا. {session} || {time}" : msg = data.customLeave;
