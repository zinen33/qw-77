...
(async function () {
  api.markAsReadAll((err) => {
	...
	logger(`${api.getCurrentUserID()} - [${global.config.PREFIX} ] • ${(!global.config.BOTNAME) ? "༻𝐎𝐖𝐍𝐄𝐑:- ☞ƤӇƠƬƠƝ 𖠰☜ ༺ ༒𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 〠Gry〠.༒ ༒𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝༒:- ☞ https://www.facebook.com/6jfl.1☜ ֎𝘊𝘰𝘯𝘵𝘢𝘤𝘵 𝘔𝘦 𝘖𝘯 𝘞𝘩𝘢𝘵𝘴𝘈𝘱𝘱֍ :-  ☞+212615924457 ☜" : global.config.BOTNAME}`, "[ BOT INFO ]");
	...
	const checkAndExecuteEvent = async () => {
		...
		//GET CURRENT TIME
		var timeVN = moment().tz('africa/morocco').format('DD/MM/YYYY_HH:mm:ss');
